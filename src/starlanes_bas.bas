...
35 REM PORT TO BAS INTERPRETER BY BEEJ JORGENSEN 11/28/22
36 REM https://www.moria.de/~michael/bas/
39 RANDOMIZE
40 PRINT CHR$(12): PRINT: PRINT: PRINT TAB(10)"* S * T * A * R **";
50 PRINT " L * A * N * E * S *"
60 DIM M(10,13), S(5,4), M$(5), D1(5), S1(5), Q(5)
65 DIM B(5), P$(5), R(5), C(5)
